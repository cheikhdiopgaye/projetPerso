...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\CompteBancaire", inversedBy="user", cascade={"persist", "remove"})
     */
    private $compteuser;
    ...
    public function getCompteuser(): ?CompteBancaire
    {
        return $this->compteuser;
    }

    public function setCompteuser(?CompteBancaire $compteuser): self
    {
